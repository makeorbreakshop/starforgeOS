---
summary: "Use Qwen OAuth (free tier) in StarforgeOS"
read_when:
  - You want to use Qwen with StarforgeOS
...
If you already logged in with the Qwen Code CLI, StarforgeOS will sync credentials

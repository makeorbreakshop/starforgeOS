...
if [[ -z "$version_content" ]]; then
  echo "<h2>StarforgeOS $VERSION</h2>"
  echo "<p>Latest StarforgeOS update.</p>"
  echo "<p><a href=\"https://github.com/makeorbreakshop/starforgeOS/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi

...
You can point StarforgeOS at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or StarforgeOS
...
- [Anthropic provider](/providers/anthropic) - Native StarforgeOS integration with Claude setup-token or API keys

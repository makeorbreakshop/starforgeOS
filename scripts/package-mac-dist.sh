...
#
# Output:
# - dist/StarforgeOS.app
# - dist/StarforgeOS-<version>.zip
# - dist/StarforgeOS-<version>.dmg
...
APP="$ROOT_DIR/dist/StarforgeOS.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/StarforgeOS-$VERSION.zip"
DMG="$ROOT_DIR/dist/StarforgeOS-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/StarforgeOS-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/StarforgeOS-$VERSION.dSYM.zip"

...
本指南总结了在 StarforgeOS 中开发 Pi 集成的合理工作流程。
...
状态存储在 StarforgeOS 状态目录下。默认为 `~/.starforgeos`。如果设置了 `STARFORGEOS_STATE_DIR`，则使用该目录。

要重置所有内容：

- `starforgeos.json` 用于配置
...
- https://docs.starforgeos.ai/testing
- https://docs.starforgeos.ai/start/getting-started

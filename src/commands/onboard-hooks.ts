...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.starforge.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("starforge hooks list")}`,
      `  ${formatCliCommand("starforge hooks enable <name>")}`,
      `  ${formatCliCommand("starforge hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );

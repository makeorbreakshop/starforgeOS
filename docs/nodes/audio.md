...
- **Media understanding (audio)**: If audio understanding is enabled (or auto‑detected), StarforgeOS:
...
StarforgeOS auto-detects in this order and stops at the first working option:

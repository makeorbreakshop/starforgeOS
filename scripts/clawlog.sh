...
show_usage() {
    cat << EOF
clawlog - StarforgeOS Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View StarforgeOS logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    StarforgeOS logs flow through the macOS unified log (subsystem: ai.starforgeos).

...
import { resolveOpenClawPackageRoot, resolveOpenClawPackageRootSync } from "./starforge-root.js";
...
export async function resolveControlUiDistIndexPath(
  ...
  // Fallback: traverse up and find package.json with name "starforge" + dist/control-ui/index.html
...
export function resolveControlUiRootSync(opts: ControlUiRootResolveOptions = {}): string | null {
  ...
  if (argv1Dir) {
    // starforge.mjs or dist/<bundle>.js

...
function ensureAgentConfigEntryIndex(
  state: AppViewState,
  ...
  const name = state.agentsList?.agents.find((entry) => entry.id === agentId)?.name?.trim();
  updateConfigFormValue(state, ["agents", "list", nextIndex], {
    id: agentId,
    ...(name ? { name } : {}),
  });
  return nextIndex;
        ...
        <div class="topbar-left">
          ...
          <div class="brand">
            <div class="brand-logo">
              <img src=${basePath ? `${basePath}/favicon.svg` : "/favicon.svg"} alt="StarforgeOS" />
            </div>
        ...
        <div class="nav-group nav-group--links">
          ...
          <div class="nav-group__items">
            <a
              ...
              href="https://docs.starforgeos.ai"
              target="_blank"
              rel="noreferrer"
          ...
          state.tab === "agents"
            ? renderAgents({
                ...
                onToolsProfileChange: (agentId, profile, clearAllow) => {
                  const index = ensureAgentConfigEntryIndex(state, configValue, agentId);
                  if (index == null) {
                    return;
                  }

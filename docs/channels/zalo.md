...
- Install via CLI: `starforge plugins install @openclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `starforge plugins install ./extensions/zalo`
   - From npm (if published): `starforge plugins install @openclaw/zalo`
...
- Approve via:
  - `starforge pairing list zalo`
  - `starforge pairing approve zalo <CODE>`
...
- Example: `starforge message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `starforge channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `starforge logs --follow`

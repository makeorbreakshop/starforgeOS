...
function resolveOpenClawRoot(): string {
  ...
  const override = process.env.STARFORGEOS_ROOT?.trim();
  if (override) {
  ...
  throw new Error("Unable to resolve core root. Set STARFORGEOS_ROOT to the package root.");
}

---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with StarforgeOS"
read_when:
  - You want Xiaomi MiMo models in StarforgeOS
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). StarforgeOS uses

...
StarforgeOS treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.starforgeos/settings/voicewake.json`

Shape:

```json
{ "triggers": ["starforgeos", "claude", "computer"], "updatedAtMs": 1730000000000 }
```

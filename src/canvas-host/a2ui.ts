...
export const A2UI_PATH = "/__starforge__/a2ui";

export const CANVAS_HOST_PATH = "/__starforge__/canvas";

export const CANVAS_WS_PATH = "/__starforge__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.starforgeCanvasA2UIAction.postMessage(...)
  // - Android: window.starforgeCanvasA2UIAction.postMessage(...)
  const handlerNames = ["starforgeCanvasA2UIAction"];
  ...
  globalThis.StarforgeOS = globalThis.StarforgeOS ?? {};
  globalThis.StarforgeOS.postMessage = postToNode;
  globalThis.StarforgeOS.sendUserAction = sendUserAction;
  globalThis.starforgePostMessage = postToNode;
  globalThis.starforgeSendUserAction = sendUserAction;

...
StarforgeOS has two separate “streaming” layers:
...
When block streaming is enabled, StarforgeOS can **merge consecutive block chunks**
...
When draft streaming is active, StarforgeOS disables block streaming for that reply to avoid double-streaming.

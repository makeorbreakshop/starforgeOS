...
read_when:
  - You want StarforgeOS to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables StarforgeOS to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`starforge onboard`) and `starforge channels add` list optional channel plugins.
...
```bash
starforge plugins install @openclaw/nostr
```

Use a local checkout (dev workflows):

```bash
starforge plugins install --link <path-to-starforgeos>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "starforgeos",
        "displayName": "StarforgeOS",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "starforgeos@example.com",
        "lud16": "starforgeos@example.com"
      }
    }
  }
}

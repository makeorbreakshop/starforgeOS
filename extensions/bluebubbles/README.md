...
This directory contains the **BlueBubbles external channel plugin** for StarforgeOS.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `starforgeos/plugin-sdk` helpers.

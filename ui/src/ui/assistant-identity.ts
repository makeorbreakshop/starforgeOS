...
declare global {
  interface Window {
    __STARFORGEOS_ASSISTANT_NAME__?: string;
    __STARFORGEOS_ASSISTANT_AVATAR__?: string;
  }
}
...
export function resolveInjectedAssistantIdentity(): AssistantIdentity {
  ...
  return normalizeAssistantIdentity({
    name: window.__STARFORGEOS_ASSISTANT_NAME__,
    avatar: window.__STARFORGEOS_ASSISTANT_AVATAR__,
  });
}

---
summary: "Use Synthetic's Anthropic-compatible API in StarforgeOS"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. StarforgeOS registers it as the
...
Note: StarforgeOS's Anthropic client appends `/v1` to the base URL, so use

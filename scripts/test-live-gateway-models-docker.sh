...
docker run --rm -t \
  ...
  -e STARFORGEOS_LIVE_GATEWAY_MODELS="${STARFORGEOS_LIVE_GATEWAY_MODELS:-${CLAWDBOT_LIVE_GATEWAY_MODELS:-all}}" \
  -e STARFORGEOS_LIVE_GATEWAY_PROVIDERS="${STARFORGEOS_LIVE_GATEWAY_PROVIDERS:-${CLAWDBOT_LIVE_GATEWAY_PROVIDERS:-}}" \
  -e STARFORGEOS_LIVE_GATEWAY_MODEL_TIMEOUT_MS="${STARFORGEOS_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-${CLAWDBOT_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-}}" \

...
This guide summarizes a sane workflow for working on the pi integration in StarforgeOS.
...
- Trigger the agent directly:
  - `pnpm starforge agent --message "Hello" --thinking low`
...
State lives under the StarforgeOS state directory. Default is `~/.starforgeos`. If `STARFORGEOS_STATE_DIR` is set, use that directory instead.

To reset everything:

- `starforgeos.json` for config
...
- [https://docs.starforgeos.ai/testing](https://docs.starforgeos.ai/testing)
- [https://docs.starforgeos.ai/start/getting-started](https://docs.starforgeos.ai/start/getting-started)

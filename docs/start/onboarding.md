---
summary: "First-run onboarding flow for StarforgeOS (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give StarforgeOS">
...
<Step title="CLI">
  ...
  The app can install the global `starforgeos` CLI via npm/pnpm so terminal

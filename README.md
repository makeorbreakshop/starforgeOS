# 🦞 StarforgeOS — Personal AI Assistant

> **Migration Notice**: This project was previously known as OpenClaw. If you're upgrading from OpenClaw, please see the [migration guide](https://docs.openclaw.ai/install/migrating) for important updates on configuration paths, command changes, and backward compatibility.

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/makeorbreakshop/starforgeOS/main/docs/assets/starforgeos-logo-text-dark.png">
        <img src="https://raw.githubusercontent.com/makeorbreakshop/starforgeOS/main/docs/assets/starforgeos-logo-text.png" alt="StarforgeOS" width="500">
    </picture>
</p>
...
<p align="center">
  <a href="https://github.com/makeorbreakshop/starforgeOS/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/makeorbreakshop/starforgeOS/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/makeorbreakshop/starforgeOS/releases"><img src="https://img.shields.io/github/v/release/makeorbreakshop/starforgeOS?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/starforge"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**StarforgeOS** is a _personal AI assistant_ you run on your own devices.
It answers you on the channels you already use (WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, Microsoft Teams, WebChat), plus extension channels like BlueBubbles, Matrix, Zalo, and Zalo Personal. It can speak and listen on macOS/iOS/Android, and can render a live Canvas you control. The Gateway is just the control plane — the product is the assistant.

If you want a personal, single-user assistant that feels local, fast, and always-on, this is it.

[Website](https://starforgeos.ai) · [Docs](https://docs.starforgeos.ai) · [DeepWiki](https://deepwiki.com/starforgeos/starforgeos) · [Getting Started](https://docs.starforgeos.ai/start/getting-started) · [Updating](https://docs.starforgeos.ai/install/updating) · [Showcase](https://docs.starforgeos.ai/start/showcase) · [FAQ](https://docs.starforgeos.ai/start/faq) · [Wizard](https://docs.starforgeos.ai/start/wizard) · [Nix](https://github.com/starforgeos/nix-clawdbot) · [Docker](https://docs.starforgeos.ai/install/docker) · [Discord](https://discord.gg/starforge)

Preferred setup: run the onboarding wizard (`starforge onboard`). It walks through gateway, workspace, channels, and skills. The CLI wizard is the recommended path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
Works with npm, pnpm, or bun.
New install? Start here: [Getting started](https://docs.starforgeos.ai/start/getting-started)
...
Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.6** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.starforgeos.ai/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.starforgeos.ai/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.starforgeos.ai/concepts/model-failover)
...
# or: pnpm add -g starforgeos@latest
...
Full beginner guide (auth, pairing, channels): [Getting started](https://docs.starforgeos.ai/start/getting-started)

```bash
starforge onboard --install-daemon

starforge gateway --port 18789 --verbose

# Send a message
starforge message send --to +1234567890 --message "Hello from StarforgeOS"

# Talk to the assistant (optionally deliver back to any connected channel: WhatsApp/Telegram/Slack/Discord/Google Chat/Signal/iMessage/BlueBubbles/Microsoft Teams/Matrix/Zalo/Zalo Personal/WebChat)
starforge agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.starforgeos.ai/install/updating) (and run `starforge doctor`).
...
Switch channels (git + npm): `starforge update --channel stable|beta|dev`.
Details: [Development channels](https://docs.starforgeos.ai/install/development-channels).
...
pnpm starforge onboard --install-daemon

# Dev loop (auto-reload on TS changes)
pnpm gateway:watch
```

Note: `pnpm starforge ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `starforgeos` binary.

## Security defaults (DM access)

StarforgeOS connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.starforgeos.ai/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dm.policy="pairing"` / `channels.slack.dm.policy="pairing"`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `starforge pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.dm.allowFrom` / `channels.slack.dm.allowFrom`).

Run `starforge doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.starforgeos.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.starforgeos.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, BlueBubbles (iMessage), iMessage (legacy), Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.starforgeos.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.starforgeos.ai/nodes/voicewake) + [Talk Mode](https://docs.starforgeos.ai/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.starforgeos.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.starforgeos.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.starforgeos.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.starforgeos.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.starforgeos.ai/nodes).
- **[Onboarding](https://docs.starforgeos.ai/start/wizard) + [skills](https://docs.starforgeos.ai/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=starforgeos/starforgeos&type=date&legend=top-left)](https://www.star-history.com/#starforgeos/starforgeos&type=date&legend=top-left)

## Everything we built so far

### Core platform

- [Gateway WS control plane](https://docs.starforgeos.ai/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.starforgeos.ai/web), and [Canvas host](https://docs.starforgeos.ai/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.starforgeos.ai/tools/agent-send): gateway, agent, send, [wizard](https://docs.starforgeos.ai/start/wizard), and [doctor](https://docs.starforgeos.ai/gateway/doctor).
- [Pi agent runtime](https://docs.starforgeos.ai/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.starforgeos.ai/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.starforgeos.ai/concepts/groups).
- [Media pipeline](https://docs.starforgeos.ai/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.starforgeos.ai/nodes/audio).

### Channels

- [Channels](https://docs.starforgeos.ai/channels): [WhatsApp](https://docs.starforgeos.ai/channels/whatsapp) (Baileys), [Telegram](https://docs.starforgeos.ai/channels/telegram) (grammY), [Slack](https://docs.starforgeos.ai/channels/slack) (Bolt), [Discord](https://docs.starforgeos.ai/channels/discord) (discord.js), [Google Chat](https://docs.starforgeos.ai/channels/googlechat) (Chat API), [Signal](https://docs.starforgeos.ai/channels/signal) (signal-cli), [BlueBubbles](https://docs.starforgeos.ai/channels/bluebubbles) (iMessage, recommended), [iMessage](https://docs.starforgeos.ai/channels/imessage) (legacy imsg), [Microsoft Teams](https://docs.starforgeos.ai/channels/msteams) (extension), [Matrix](https://docs.starforgeos.ai/channels/matrix) (extension), [Zalo](https://docs.starforgeos.ai/channels/zalo) (extension), [Zalo Personal](https://docs.starforgeos.ai/channels/zalouser) (extension), [WebChat](https://docs.starforgeos.ai/web/webchat).
- [Group routing](https://docs.starforgeos.ai/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.starforgeos.ai/channels).

### Apps + nodes

- [macOS app](https://docs.starforgeos.ai/platforms/macos): menu bar control plane, [Voice Wake](https://docs.starforgeos.ai/nodes/voicewake)/PTT, [Talk Mode](https://docs.starforgeos.ai/nodes/talk) overlay, [WebChat](https://docs.starforgeos.ai/web/webchat), debug tools, [remote gateway](https://docs.starforgeos.ai/gateway/remote) control.
- [iOS node](https://docs.starforgeos.ai/platforms/ios): [Canvas](https://docs.starforgeos.ai/platforms/mac/canvas), [Voice Wake](https://docs.starforgeos.ai/nodes/voicewake), [Talk Mode](https://docs.starforgeos.ai/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.starforgeos.ai/platforms/android): [Canvas](https://docs.starforgeos.ai/platforms/mac/canvas), [Talk Mode](https://docs.starforgeos.ai/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.starforgeos.ai/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](https://docs.starforgeos.ai/tools/browser): dedicated starforge Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.starforgeos.ai/platforms/mac/canvas): [A2UI](https://docs.starforgeos.ai/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.starforgeos.ai/nodes): camera snap/clip, screen record, [location.get](https://docs.starforgeos.ai/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.starforgeos.ai/automation/cron-jobs); [webhooks](https://docs.starforgeos.ai/automation/webhook); [Gmail Pub/Sub](https://docs.starforgeos.ai/automation/gmail-pubsub).
- [Skills platform](https://docs.starforgeos.ai/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](https://docs.starforgeos.ai/concepts/channel-routing), [retry policy](https://docs.starforgeos.ai/concepts/retry), and [streaming/chunking](https://docs.starforgeos.ai/concepts/streaming).
- [Presence](https://docs.starforgeos.ai/concepts/presence), [typing indicators](https://docs.starforgeos.ai/concepts/typing-indicators), and [usage tracking](https://docs.starforgeos.ai/concepts/usage-tracking).
- [Models](https://docs.starforgeos.ai/concepts/models), [model failover](https://docs.starforgeos.ai/concepts/model-failover), and [session pruning](https://docs.starforgeos.ai/concepts/session-pruning).
- [Security](https://docs.starforgeos.ai/gateway/security) and [troubleshooting](https://docs.starforgeos.ai/channels/troubleshooting).

### Ops + packaging

- [Control UI](https://docs.starforgeos.ai/web) + [WebChat](https://docs.starforgeos.ai/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.starforgeos.ai/gateway/tailscale) or [SSH tunnels](https://docs.starforgeos.ai/gateway/remote) with token/password auth.
- [Nix mode](https://docs.starforgeos.ai/install/nix) for declarative config; [Docker](https://docs.starforgeos.ai/install/docker)-based installs.
- [Doctor](https://docs.starforgeos.ai/gateway/doctor) migrations, [logging](https://docs.starforgeos.ai/logging).
...
- **[Gateway WebSocket network](https://docs.starforgeos.ai/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.starforgeos.ai/gateway)).
- **[Tailscale exposure](https://docs.starforgeos.ai/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.starforgeos.ai/gateway/remote)).
- **[Browser control](https://docs.starforgeos.ai/tools/browser)** — starforgeos‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.starforgeos.ai/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.starforgeos.ai/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.starforgeos.ai/nodes/voicewake) + [Talk Mode](https://docs.starforgeos.ai/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.starforgeos.ai/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.

## Tailscale access (Gateway dashboard)

StarforgeOS can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (StarforgeOS enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](https://docs.starforgeos.ai/gateway/tailscale) · [Web surfaces](https://docs.starforgeos.ai/web)
...
Details: [Remote access](https://docs.starforgeos.ai/gateway/remote) · [Nodes](https://docs.starforgeos.ai/nodes) · [Security](https://docs.starforgeos.ai/gateway/security)
...
Details: [Nodes](https://docs.starforgeos.ai/nodes) · [macOS app](https://docs.starforgeos.ai/platforms/macos) · [Gateway protocol](https://docs.starforgeos.ai/concepts/architecture)
...
Details: [Session tools](https://docs.starforgeos.ai/concepts/session-tool)
...
### macOS (StarforgeOS.app) (optional)
...
- Controlled via `starforge nodes …`.

Runbook: [iOS connect](https://docs.starforgeos.ai/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.starforgeos.ai/platforms/android).

## Agent workspace + skills

- Workspace root: `~/.starforgeos/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.starforgeos/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.starforgeos/starforgeos.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.starforgeos.ai/gateway/configuration)
...
Details: [Security guide](https://docs.starforgeos.ai/gateway/security) · [Docker + sandboxing](https://docs.starforgeos.ai/install/docker) · [Sandbox config](https://docs.starforgeos.ai/gateway/configuration)

### [WhatsApp](https://docs.starforgeos.ai/channels/whatsapp)

- Link the device: `pnpm starforge channels login` (stores creds in `~/.starforgeos/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.starforgeos.ai/channels/telegram)
...
### [Slack](https://docs.starforgeos.ai/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.starforgeos.ai/channels/discord)
...
### [Signal](https://docs.starforgeos.ai/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [BlueBubbles (iMessage)](https://docs.starforgeos.ai/channels/bluebubbles)

- **Recommended** iMessage integration.
- Configure `channels.bluebubbles.serverUrl` + `channels.bluebubbles.password` and a webhook (`channels.bluebubbles.webhookPath`).
- The BlueBubbles server runs on macOS; the Gateway can run on macOS or elsewhere.

### [iMessage (legacy)](https://docs.starforgeos.ai/channels/imessage)

- Legacy macOS-only integration via `imsg` (Messages must be signed in).
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.starforgeos.ai/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.starforgeos.ai/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.starforgeos.ai)
- [Read the architecture overview for the gateway + protocol model.](https://docs.starforgeos.ai/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.starforgeos.ai/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.starforgeos.ai/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.starforgeos.ai/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.starforgeos.ai/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.starforgeos.ai/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.starforgeos.ai/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.starforgeos.ai/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.starforgeos.ai/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.starforgeos.ai/platforms/windows), [Linux](https://docs.starforgeos.ai/platforms/linux), [macOS](https://docs.starforgeos.ai/platforms/macos), [iOS](https://docs.starforgeos.ai/platforms/ios), [Android](https://docs.starforgeos.ai/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.starforgeos.ai/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.starforgeos.ai/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.starforgeos.ai/gateway/discovery)
- [Bonjour/mDNS](https://docs.starforgeos.ai/gateway/bonjour)
- [Gateway pairing](https://docs.starforgeos.ai/gateway/pairing)
- [Remote gateway README](https://docs.starforgeos.ai/gateway/remote-gateway-readme)
- [Control UI](https://docs.starforgeos.ai/web/control-ui)
- [Dashboard](https://docs.starforgeos.ai/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.starforgeos.ai/gateway/health)
- [Gateway lock](https://docs.starforgeos.ai/gateway/gateway-lock)
- [Background process](https://docs.starforgeos.ai/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.starforgeos.ai/tools/browser-linux-troubleshooting)
- [Logging](https://docs.starforgeos.ai/logging)

## Deep dives

- [Agent loop](https://docs.starforgeos.ai/concepts/agent-loop)
- [Presence](https://docs.starforgeos.ai/concepts/presence)
- [TypeBox schemas](https://docs.starforgeos.ai/concepts/typebox)
- [RPC adapters](https://docs.starforgeos.ai/reference/rpc)
- [Queue](https://docs.starforgeos.ai/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.starforgeos.ai/tools/skills-config)
- [Default AGENTS](https://docs.starforgeos.ai/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.starforgeos.ai/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.starforgeos.ai/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.starforgeos.ai/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.starforgeos.ai/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.starforgeos.ai/reference/templates/TOOLS)
- [Templates: USER](https://docs.starforgeos.ai/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.starforgeos.ai/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.starforgeos.ai/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.starforgeos.ai/platforms/mac/voicewake)
- [iOS node](https://docs.starforgeos.ai/platforms/ios)
- [Android node](https://docs.starforgeos.ai/platforms/android)
- [Windows (WSL2)](https://docs.starforgeos.ai/platforms/windows)
- [Linux app](https://docs.starforgeos.ai/platforms/linux)

## Email hooks (Gmail)

- [docs.starforgeos.ai/gmail-pubsub](https://docs.starforgeos.ai/automation/gmail-pubsub)

## Molty

StarforgeOS was built for **Molty**, a space lobster AI assistant. 🦞
by Peter Steinberger and the community.

- [starforgeos.ai](https://starforgeos.ai)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@starforgeos](https://x.com/starforgeos)
